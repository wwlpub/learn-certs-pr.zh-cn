...
![单击考试折扣页面中的验证帐户按钮](images/step5.png)

**步骤 6：** 验证帐户时，您必须使用活动注册时的帐户进行身份验证(注意：如果您在注册活动时使用Microsoft帐户，则必须使用相同的Microsoft帐户登录访问认证档案以安排考试。如果这导致有两个认证个人资料，请在您完成考试后联系[Microsoft 认证支持](https://trainingsupport.microsoft.com/en-us/mcp/forum)，合并您的个人资料。
<br/><br/>

![使用相同的社交账户认证以验证账户](images/step6.png)

**步骤 7：** 按照以下屏幕上的步骤进行操作，并提供安排考试所需的详细信息。在结帐期间，请确认应付的总金额为 $0.00 并提交订单。
<br/><br/>

![提供安排考试所需的详细信息](images/step7.png)

### 认证支持：

对于安排考试的问题，请通过 [Microsoft认证支持](https://trainingsupport.microsoft.com/en-us/mcp/forum) 获得帮助。论坛版主将在一个工作日内回复。

## <a name="eligible-exams"></a> 适用的考试

符合资格的考试包括所有的 Microsoft 基础知识、基于角色的和专业认证考试。适用的考试如下所示。  
...
**答：** 此优惠包括所有Microsoft基础，基于角色的考试和专业考试。有关符合资格认证考试的列表，请参阅我们的“优惠详情”页上的“ [符合资格的考试](#eligible-exams)”部分。

**问题：如果我注册了 Microsoft Build，但没有注册或完成云技能挑战，是否仍可以申请此优惠？**

**答：** 不，此优惠仅适用于参加过 Microsoft Build 并完成了“云技能挑战”中的一个集合的用户。
...
**答：** 您可以联系 [Microsoft Certification Support](https://trainingsupport.microsoft.com/en-us/mcp/forum)以获得帮助。版主将在一个工作日内回复。

**问题：我可以选择现场或在线参加安排的考试吗？**

**答：** 是的，您可以选择亲自到当地的考试中心通过 Pearson Vue 或通过[在线](/learn/certifications/online-exams)参加预定的考试。由于新型冠状病毒(COVID-19)的限制，考试中心可能暂时关闭。了解最新信息[来自于Pearson Vue的考试可用性信息](https://home.pearsonvue.com/coronavirus-update).
...
- 该考试优惠可以兑换为一(1)次 Microsoft 认证考试，在经过授权的 Pearson Vue 测试中心或通过 Pearson Vue 在线代理站点参加此考试。
- 此考试优惠是针对特定考试的，并且只能用于选定的 Microsoft 考试。
...
有关更多的信息，请参阅完整的[Microsoft 使用条款](https://www.microsoft.com/en-us/legal/intellectualproperty/copyright/default.aspx?SilentAuth=1).
