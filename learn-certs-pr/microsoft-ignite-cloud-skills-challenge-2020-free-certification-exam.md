...
合格的考试包括所有Microsoft基础知识，基于角色的考试和专业认证考试。适用的考试如下所示。 
...
**答:** 此优惠包括所有Microsoft基础，基于角色的考试和专业考试。有关符合资格的认证考试的列表，请参阅我们的“优惠详情”页上的“ [符合资格的考试](/learn/certifications/microsoft-build-cloud-skills-challenge-2020-free-certification-exam-offer#eligible-exams)”部分。

**问题:如果我注册了 Microsoft Ignite，但没有注册或完成云技能挑战，是否仍可以申请此优惠？**

**答:** 不，此优惠仅适用于参加过 Microsoft Ignite 并完成了“云技能挑战”中的一个集合的用户。 

### 安排免费考试 

**问题:我需要在 2021 年 3 月 31 日或之前参加考试吗？**

**答:** 是的，您确实需要在 2021 年 3 月 31 日或之前参加考试。 

**问题:我在安排免费考试时遇到了麻烦。我可以在哪里获得帮助？**

**答:** 您可以联系 [Microsoft Certification Support](https://trainingsupport.microsoft.com/zh-cn/mcp/forum/mcp_exams-mcp_offer-mcp_eventoffer?sort=LastReplyDate&dir=Desc&tab=All&status=all&mod=&modAge=&advFil=&postedAfter=&postedBefore=&threadType=all&isFilterExpanded=false&page=1)以获得帮助。版主将在一个工作日内回复。
