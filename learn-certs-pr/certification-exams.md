...
6. 最终确定题库。
测试版测试的结果在心理测量方面分析了难度、区分高低表现者能力和可靠性等因素。仅符合 Microsoft 的心理测量条件的那些考题将出现在正式考试中。
...
有关如何准备没有准备材料的测试版考试的更多建议和想法，请参阅：[如何在没有备考材料的情况下为测试版考试做准备？](/learn/certifications/posts/just-how-does-one-prepare-for-beta-exams-without-preparation-materials)
...
在您的认证途径中通过测试版考试非常重要。您无需 重新参加最终版本的考试。确保您在一年内参加另一场考试，以便可以通过我们的测试版考试折扣计划享受您通过测试版考试获得的25％折扣。

如果您未通过测试版考试，则不能重新参加测试版考试。如果您有兴趣获得需要成功完成该考试的认证，则必须等到正式上线后再按常规费用重新参加考试，否则，您可以通过我们的测试版考试应用所获得的25％折扣来参加测试版考试折扣计划。
