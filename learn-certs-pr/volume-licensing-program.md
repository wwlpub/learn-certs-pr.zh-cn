...
* Microsoft Imagine Academy(适用于符合条件的组织)
  ...
  Microsoft Imagine Academy（MSIA）计划是一项提供技术课程、教学资源及与需求的劳动力/职业技能相匹配的相关福利的技能福利。综合学习路径和课程将使学生为顺利地完成行业认可的认证并就业做好准备。教材包括用于Microsoft Office Specialist、Microsoft Technology Associate和Microsoft Fundamentals认证准备的课程。

  Microsoft Imagine Academy将提供以下福利：

  * 用于教职员工职业发展（MOS、MTA、Fundamentals和 MCE）的30张免费认证考试券/VL协议（学校之间共享）
  * 生产力（MOS）课程和入门级IT（MTA）课程的课程内容包-MOAC
  * MOS 2016版和MOS 2019/O365版考试教程
  * MCT (Microsoft Certified Trainer) 计划享受五折优惠
  * Microsoft Official Courseware (MOC)内容使用权
  * 定制课程结业证书
  * Microsoft Press书籍享受六折优惠 

  首次购买或续订EES (入学教育解决方案)、School和OVS-ES（开放式订阅-入学订阅）批量许可订阅后，可访问Microsoft Imagine Academy (MSIA)，作为计划技能福利，无需支付额外费用。

* 适用于学术机构的 Microsoft 认证考试包

  借助 Microsoft 认证，您可以验证学生的技术技能，帮助他们与众不同并增强他们的教育和职业前景。另外，您可以使用 Microsoft 认证为您教职员工的专业发展目标提供支持。

  您可以订购考试班和网站包，这些资源能让学生为取得Microsoft认证而做好准备—包括Microsoft Office Specialist (MOS)、Microsoft Technology Associate (MTA)、Fundamentals和Microsoft Certified Professional等认证。 认证考试课程和站点包包括特定数量的考试优惠券，您可以在一年的时间内使用这些优惠券。无论是就读高中，两年制大学还是四年制大学，您都可以量身定制各种认证，以满足您的独特需求。
  ...
  您可以通过下面的Microsoft Academic Volume Licensing计划来订购您的Microsoft Certification考试包：

  EES (入学教育解决方案)、School和OVS-ES (开放式订阅-入学订阅)批量许可订阅。  如需了解更多详情，请联系您的学术授权经销商或访问[Microsoft Licensing行业计划](https://www.microsoft.com/licensing/licensing-options/for-industries.aspx)页面。

  **其他批量许可学术认证资源**

  * [Microsoft Imagine Academy计划权益指南](https://www.microsoft.com/en-us/education/imagine-academy)
...
* 其他批量许可学术电子学习资源
  ...
  * [Microsoft Imagine Academy 课程](https://www.microsoft.com/en-us/education/imagine-academy)
...
**问题：Microsoft 培训和认证解决方案与其他批量许可在线服务的定价和订阅模型之间有什么区别？**
